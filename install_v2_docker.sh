...
mkdir /tmp/$suijishu
cd /tmp/$suijishu
wget https://raw.githubusercontent.com/siemenstutorials/V2raySSPANEL/master/docker-compose.yml
...
sed -i "s|https://www.xjycloud.pw|$dockerurl|" docker-compose.yml
docker-compose up -d
docker ps
echo $suijishu
